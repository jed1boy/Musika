  ...
  return (
    <section className="w-full max-w-[1440px] mx-auto px-6 md:px-12 py-24 md:py-40 flex flex-col items-center justify-center text-center">
      <div className="w-full bg-white text-black rounded-[48px] md:rounded-[80px] p-12 md:p-32 flex flex-col items-center">
        <h2 className="text-5xl md:text-[100px] leading-[0.9] font-semibold tracking-tighter mb-8 max-w-4xl">
          READY TO LISTEN?
        </h2>
        ...
        <div className="relative group">
          <a
            ...
            className="flex items-center justify-center gap-4 px-8 py-5 bg-black text-white rounded-[32px] overflow-hidden hover:bg-neutral-800 active:scale-[0.98] transition-all duration-200 ease-out text-lg font-semibold tracking-tight"
          >
