...
import com.musika.app.constants.LastLibSongSyncKey
import com.musika.app.constants.LastLikeSongSyncKey
...
import com.musika.app.constants.MiniPlayerHeight
import com.musika.app.constants.MiniPlayerBottomSpacing
import com.musika.app.constants.UpdateNotificationsEnabledKey
import com.musika.app.constants.UseNewMiniPlayerDesignKey
import com.musika.app.constants.NavigationBarAnimationSpec
...
import com.musika.app.constants.SlimNavBarHeight
...
import com.musika.app.playback.DownloadUtil
...
import com.musika.app.ui.component.AccountSettingsDialog
import com.musika.app.ui.component.BottomSheetMenu
import com.musika.app.ui.component.BottomSheetPage
import com.musika.app.ui.component.IconButton
import com.musika.app.ui.component.ImportantNoticeDialog
import com.musika.app.ui.component.LocalBottomSheetPageState
import com.musika.app.ui.component.LocalMenuState
import com.musika.app.ui.component.TopSearch
import com.musika.app.ui.component.rememberBottomSheetState
import com.musika.app.ui.component.shimmer.ShimmerTheme
import com.musika.app.ui.menu.YouTubeSongMenu
import com.musika.app.ui.player.BottomSheetPlayer
import com.musika.app.ui.screens.Screens
import com.musika.app.ui.screens.navigationBuilder
import com.musika.app.ui.screens.search.LocalSearchScreen
...
import com.musika.app.ui.utils.resetHeightOffset
...
MusikaTheme(
                ...
                BoxWithConstraints(
                    ...
                    val (showFindInNavbar) = rememberPreference(com.musika.app.constants.ShowFindInNavbarKey, defaultValue = true)
...
NavigationBarItem(
    ...
    companion object {
        const val ACTION_SEARCH = "com.musika.app.action.SEARCH"
        const val ACTION_LIBRARY = "com.musika.app.action.LIBRARY"
        const val ACTION_FIND = "com.musika.app.action.FIND"
    }
}
