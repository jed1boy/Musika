...
fun AdvancedDownloadDialog(
    ...
    var defaultDownloadPath by remember { mutableStateOf("Downloads/Musika") }
...
fun downloadFile(context: Context, url: String, fileName: String, destinationUri: Uri?) {
    ...
    try {
        ...
        if (destinationUri != null) {
              ...
              // For now, let's use the standard "Downloads/Musika" SubPath approach which works well.
              ...
              // but create a subfolder.
               ...
               request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "Musika/$fileName")
               Toast.makeText(context, "Downloading to Downloads/Musika", Toast.LENGTH_SHORT).show()
